...
def main():
    app = Application(consumer_group="visitors-15min2", use_changelog_topics=False)
    ...
    sdf = sdf.hopping_window(timedelta(minutes=15), timedelta(seconds=10)).reduce(row_processor, lambda r: row_processor({}, r)).current()
